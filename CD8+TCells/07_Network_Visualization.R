...
healthy_genemean <- read.table("./CD8network/HealthyGeneMean.txt")
mild_genemean <- read.table("./CD8network/MildGeneMean.txt")
severe_genemean <- read.table("./CD8network/SevereGeneMean.txt")
...
healthy1 <- subset(healthy1, V3 > 0.997)
mild1 <- subset(mild1, V3 > 0.997)
severe1 <- subset(severe1, V3 > 0.997)
...
saveRDS(mat0, "./CD8network/mat0.rds")
...
healthy <- subset(healthy, V3 > 0.997)
mild <- subset(mild, V3 > 0.997)
severe <- subset(severe, V3 > 0.997)
