...
healthy <- read.table("./CD8network/HealthyPIDC.txt", header=FALSE)
covid <- read.table("./CD8network/MildPIDC.txt", header=FALSE)
...
perm.sN <- foreach(i = 1:num.perm, .combine=rbind) %dopar% {
    ...
    hperm <- read.table(paste0("./CD8network/HealthyMildPIDC/netH", i, ".txt"), header=FALSE)
    cperm <- read.table(paste0("./CD8network/HealthyMildPIDC/netM", i, ".txt"), header=FALSE)
...
save.image("./CD8network/Permtest_HM.RData")
...
healthy <- read.table("./CD8network/HealthyPIDC.txt", header=FALSE)
covid <- read.table("./CD8network/SeverePIDC.txt", header=FALSE)
...
perm.sN <- foreach(i = 1:num.perm, .combine=rbind) %dopar% {
    cat("permutation", i, "out of", num.perm,"\n")
    hperm <- read.table(paste0("./CD8network/HealthySeverePIDC/netH", i, ".txt"), header=FALSE)
    cperm <- read.table(paste0("./CD8network/HealthySeverePIDC/netS", i, ".txt"), header=FALSE)
    matperm <- cor_mat(hperm, cperm)
    perm.s1 <- matperm[[1]]
    perm.s2 <- matperm[[2]]
    for (g in 1:nG) {
...
save.image("./CD8network/Permtest_HS.RData")
...
mild <- read.table("./CD8network/MildPIDC.txt", header=FALSE)
severe <- read.table("./CD8network/SeverePIDC.txt", header=FALSE)
...
perm.sN <- foreach(i = 1:num.perm, .combine=rbind) %dopar% {
    cat("permutation", i, "out of", num.perm,"\n")
    hperm <- read.table(paste0("./CD8network/MildSeverePIDC/netM", i, ".txt"), header=FALSE)
    cperm <- read.table(paste0("./CD8network/MildSeverePIDC/netS", i, ".txt"), header=FALSE)
    matperm <- cor_mat(hperm, cperm)
    perm.s1 <- matperm[[1]]
    perm.s2 <- matperm[[2]]
    for (g in 1:nG) {
...
save.image("./CD8network/Permtest_MS.RData")
